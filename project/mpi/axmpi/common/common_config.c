...
AX_MIPI_TX_ATTR_S gOs04a10MipiTxIspBypassAttr = {
    ...
    .eDataRate    = AX_MIPI_DATA_RATE_800M,
    .eInputSrc    = AX_MIPI_TX_SRC_SNS_2,
...
axsns_clk_attr_t gOs04a10SnsClkAttr = {
    .nSnsClkIdx  = 0,
...
AX_DEV_ATTR_T gOs04a10DevAttr = {
    ...
    .eSnsGainMode   = (AX_SNS_GAIN_MODE_E)0,
    .eSnsMode       = AX_SNS_LINEAR_MODE,
...
AX_MIPI_TX_ATTR_S gImx334MipiTxIspBypassAttr = {
    .bIspBypass   = AX_TRUE,
    .eLaneNum     = AX_MIPI_LANE_4,
    .eDataRate    = AX_MIPI_DATA_RATE_1000M,
    .eInputSrc    = AX_MIPI_TX_SRC_SNS_0,
    .eDolSplitNum = AX_MIPI_DOL_1,
    .eImgDataType = AX_MIPI_DT_RAW10,
    .eImgVC       = AX_MIPI_VC_0,
    .nImgWidth    = 3840,
...
axsns_clk_attr_t gImx334SnsClkAttr = {
    .nSnsClkIdx  = 0,
...
axsns_clk_attr_t gGc4653SnsClkAttr = {
    .nSnsClkIdx  = 0,
    .eSnsClkRate = AX_SNS_CLK_24M,
};
...
axsns_clk_attr_t gOs08a20SnsClkAttr = {
    .nSnsClkIdx  = 0,
    .eSnsClkRate = AX_SNS_CLK_24M,
};
...
axsns_clk_attr_t gDVPSnsClkAttr = {
    .nSnsClkIdx = 0,
    .eSnsClkRate = AX_SNS_CLK_24M,
};
