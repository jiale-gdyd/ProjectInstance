#ifndef DSL_DSL_SOURCE_BINTR_H
#define DSL_DSL_SOURCE_BINTR_H
...
#define DSL_APP_SOURCE_NEW(name, isLive, bufferInFormat, width, height, fpsN, fpsD) \
    std::shared_ptr<AppSourceBintr>(new AppSourceBintr(name, isLive, bufferInFormat, width, height, fpsN, fpsD))
...
#define DSL_URI_SOURCE_NEW(name, uri, isLive, skipFrames, dropFrameInterval) \
    std::shared_ptr<UriSourceBintr>(new UriSourceBintr(name, uri, isLive, skipFrames, dropFrameInterval))
...
#define DSL_IMAGE_STREAM_SOURCE_NEW(name, uri, isLive, fpsN, fpsD, timeout) \
    std::shared_ptr<ImageStreamSourceBintr>(new ImageStreamSourceBintr(name, uri, isLive, fpsN, fpsD, timeout))
...
#define DSL_INTERPIPE_SOURCE_NEW(name, listenTo, isLive, acceptEos, acceptEvents) \
    std::shared_ptr<InterpipeSourceBintr>(new InterpipeSourceBintr(name, listenTo, isLive, acceptEos, acceptEvents))
...
#define DSL_RTSP_SOURCE_NEW(name, uri, protocol, \
    ...
    std::shared_ptr<RtspSourceBintr>(new RtspSourceBintr(name, uri, protocol, skipFrames, dropFrameInterval, latency, timeout))

#define DSL_DUPLICATE_SOURCE_PTR std::shared_ptr<DuplicateSourceBintr>
#define DSL_DUPLICATE_SOURCE_NEW(name, original, isLive) \
    std::shared_ptr<DuplicateSourceBintr>(new DuplicateSourceBintr(name, original, isLive))
