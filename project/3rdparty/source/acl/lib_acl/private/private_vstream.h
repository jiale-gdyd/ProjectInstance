#ifndef ACL_LIB_ACL_PRIVATE_PRIVATE_VSTREAM_H
#define ACL_LIB_ACL_PRIVATE_PRIVATE_VSTREAM_H
...
ACL_VSTREAM *private_vstream_fdopen(ACL_SOCKET fd, unsigned int oflags, size_t buflen, int rw_timeo, int fdtype);
...
ACL_VSTREAM *private_vstream_connect_ex(const char *addr, int block_mode, int conn_timeout, int rw_timeout, int rw_bufsize, int *he_errorp);
