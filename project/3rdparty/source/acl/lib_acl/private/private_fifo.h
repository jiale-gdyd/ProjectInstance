#ifndef ACL_LIB_ACL_PRIVATE_PRIVATE_FIFO_H
#define ACL_LIB_ACL_PRIVATE_PRIVATE_FIFO_H

#include "acl/lib_acl/stdlib/acl_fifo.h"
...
#define	PRIVATE_FIFO_PUSH(_fifo, _data) \
    do {  \
        ACL_FIFO_INFO *_info;  \
...
#define	PRIVATE_FIFO_POP(_fifo, _data_ptr) \
    do {  \
        ACL_FIFO_INFO *_info;  \
        if ((_fifo)->head != NULL) {  \
            _info = (_fifo)->head;  \
