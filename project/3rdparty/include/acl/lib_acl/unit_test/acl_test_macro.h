#ifndef ACL_LIBACL_UNIT_TEST_ACL_TEST_MACRO_H
#define ACL_LIBACL_UNIT_TEST_ACL_TEST_MACRO_H
...
#define AUT_STR(__test_line__, __name__, __value__, __def__) \
    do {  \
        __value__ = aut_line_getvalue(__test_line__, __name__);  \
        if (__value__ == NULL) {  \
            __value__ = __def__; \
...
#define AUT_INT(__test_line__, __name__, __value__, __def__) \
    do {  \
        const char *__ptr__;  \
        __ptr__ = aut_line_getvalue(__test_line__, __name__);  \
        if (__ptr__ == NULL) {  \
