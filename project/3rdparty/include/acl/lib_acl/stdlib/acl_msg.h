#ifndef ACL_LIBACL_STDLIB_ACL_MSG_H
#define ACL_LIBACL_STDLIB_ACL_MSG_H
 ...
 * @param file_name {const char*} 回传给自定义日志打开函数的参数，即将日志文件回传
 ...
 * @param ... 变参序列
 */
ACL_API void ACL_PRINTF(2, 3) acl_msg_fatal_status(int status, const char *fmt,...);
