...
typedef enum _Rga_SURF_FORMAT {
    ...
    RK_FORMAT_YCbCr_444_SP = 0x32 << 8, /*  2 plane YCbCr little endian plane 0: [0:7] Y plane 1: non-subsampled [0:15] Cb:Cr 8:8  */
    RK_FORMAT_YCrCb_444_SP = 0x33 << 8, /*  2 plane YCrCb little endian plane 0: [0:7] Y plane 1: non-subsampled [0:15] Cr:Cb 8:8  */
...
enum {
    ...
    yuv2rgb_709_full              = 0xc << 8,
    yuv2yuv_601_limit_2_601_full  = 0xd << 8,
    yuv2yuv_601_full_2_601_limit  = 0xe << 8,
    yuv2yuv_709_limit_2_709_full  = 0xf << 8,
    yuv2yuv_709_full_2_709_limit  = 0x10 << 8,
    full_csc_mask                 = 0xf00,
};
