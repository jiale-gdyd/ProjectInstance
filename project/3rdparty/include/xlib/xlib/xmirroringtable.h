#define PACKTAB_UINT8 xuint8
#define PACKTAB_UINT16 xuint16
#define PACKTAB_UINT32 xuint32

static const xint16 MirLev3[4*49] = {
...
#define XLIB_GET_MIRRORING_DELTA(x)         ((x) >= 0x10000 ? 0 :  MirLev3[((x) & 0x03) + MirLev2[((x) >> 2 & 0x03) + MirLev1[((x) >> 4 & 0x0f) + MirLev0[((x) >> 8)]]]])

#undef PACKTAB_UINT8
#undef PACKTAB_UINT16
#undef PACKTAB_UINT32

#define XLIB_GET_MIRRORING(x)               ((x) + XLIB_GET_MIRRORING_DELTA(x))
