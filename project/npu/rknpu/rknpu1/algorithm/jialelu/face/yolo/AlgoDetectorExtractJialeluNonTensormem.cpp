...
int AlgoDetector::extract_yolox_tiny_face_non_tensormem_jialelu(rknn_output *output, std::vector<rknn_tensor_attr> attr, size_t output_count, nms_func_ptr nms_callback, void *args, std::map<int, std::vector<bbox>> &lastResults)
{
...
int AlgoDetector::extract_yolox_nano_face_one_anchor_non_tensormem_jialelu(rknn_output *output, std::vector<rknn_tensor_attr> attr, size_t output_count, nms_func_ptr nms_callback, void *args, std::map<int, std::vector<bbox>> &lastResults)
{
    algo_args_t *pArgs = (algo_args_t *)args;
    const int m_classes = int(pArgs->classCount);
    std::vector<int> filterClass = pArgs->filterClass;
...
int AlgoDetector::extract_yolox_nano_face_one_anchor_tiny_non_tensormem_jialelu(rknn_output *output, std::vector<rknn_tensor_attr> attr, size_t output_count, nms_func_ptr nms_callback, void *args, std::map<int, std::vector<bbox>> &lastResults)
{
    algo_args_t *pArgs = (algo_args_t *)args;
    const int m_classes = int(pArgs->classCount);
    std::vector<int> filterClass = pArgs->filterClass;
